...
config :demo_phoenix_inertia_svelte, DemoPhoenixInertiaSvelte.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "demo_phoenix_inertia_svelte_dev",
  stacktrace: true,
...
config :demo_phoenix_inertia_svelte, DemoPhoenixInertiaSvelteWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/demo_phoenix_inertia_svelte_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :demo_phoenix_inertia_svelte, dev_routes: true
